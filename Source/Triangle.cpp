...
namespace luna {
    ...
    std::optional<Intersection> Triangle::getIntersectionPoint(const Ray& ray) const {
        ...
        return std::make_optional<Intersection>(ray.pointAt(glm::dot(p0p2, qvec) * invDet), normal);
    }
